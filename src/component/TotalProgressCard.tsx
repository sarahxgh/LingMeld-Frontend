...
const TotalProgressCard: React.FC = () => {
  const stats = {
    level: 10,
    courses: 145,
    quizzes: 1465,
  ...
  return (
    <article className="flex bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 p-7 bg-[#F1F1F1] overflow-hidden"> {/* Added overflow-hidden */}
      <div className="flex flex-col w-full max-md:max-w-full">
        ...
        <div className="flex gap-10 items-center self-end mt-7 max-md:max-w-full">
          ...
          <div className="flex flex-col self-stretch my-auto w-[217px] space-y-6">
            <div className="flex overflow-hidden flex-col justify-center p-8 w-full rounded-3xl h-[93px] bg-[#A7EA1C] backdrop-blur-sm"> {/* Removed -ml-20 */}
          ...
          <div className="w-[206px] flex justify-center items-center">
            <div className="relative w-[200px] h-[200px]"> {/* Increased size */}
              {/* Circular Progress */}
              <CircularProgressbar
